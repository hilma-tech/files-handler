...
ALTER TABLE Audio MODIFY COLUMN `format` enum('mp3', 'm4a', 'wav', 'webm', 'aac') CHARACTER SET utf8 DEFAULT NULL;
...
ALTER TABLE Audio MODIFY COLUMN `format` enum('mp3', 'm4a', 'wav', 'mpeg', 'webm', 'aac') CHARACTER SET utf8 DEFAULT NULL;
